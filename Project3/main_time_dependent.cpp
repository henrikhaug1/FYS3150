...
{	
    ...
    for(int i = 0; i < f_fine.n_elem; i++)
    {
        ...
        std::string filename_particles_inside = "txt_files/f_fine_non_interaction" + std::to_string(f[i]) + ".txt";
    ...
    for(int i = 0; i < f_fine.n_elem; i++)
    {
        ...
        std::string filename_particles_inside = "txt_files/f_fine_interaction" + std::to_string(f[i]) + ".txt";
